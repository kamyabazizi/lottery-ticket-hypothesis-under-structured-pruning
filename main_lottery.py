...
model = mol.__dict__[args.arch](dataset=args.dataset, depth=args.depth)
model_ref = mol.__dict__[args.arch](dataset=args.dataset, depth=args.depth)
...
def test():
    ...
    latency = cost/100
    macs, params = get_model_complexity_info(model,(3,32,32),print_per_layer_stat=False,verbose=False)
    test_loss /= len(test_loader.dataset)
    print('{:<30}  {:<8}'.format('Computational complexity: ', macs))
    print('{:<30}  {:<8}'.format('latency: ', latency))
