...
parser.add_argument('--saveb', default='', type=str, metavar='PATH',
                    help='path to save first model (default: none)')                    
...
torch.save(model.state_dict(), os.path.join(args.saveb, 'btrain.pth.tar'))
